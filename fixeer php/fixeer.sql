...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/08/2024 às 22:58
...
--
ALTER TABLE `trabalhadores`
  ADD CONSTRAINT `trabalhadores_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
COMMIT;
